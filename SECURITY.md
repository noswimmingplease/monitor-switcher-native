...
Security fixes are provided for the latest published release. Older builds may be used for rollback, but they are not maintained as separate supported versions.
...
For ordinary defects that do not have a security impact, use the repository's bug-report template.
